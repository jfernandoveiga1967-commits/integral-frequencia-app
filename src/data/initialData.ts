...
export const INITIAL_HOLIDAYS: HolidayItem[] = [
  ...
  { id: 'hol_2026_02_16', date: '2026-02-16', name: 'Recesso de Carnaval (Segunda-feira)', type: 'recesso', description: 'Recesso Escolar de Carnaval' },
  { id: 'hol_2026_02_17', date: '2026-02-17', name: 'Carnaval (Terça-feira)', type: 'feriado', description: 'Feriado / Ponto Facultativo de Carnaval' },
  { id: 'hol_2026_02_18', date: '2026-02-18', name: 'Quarta-feira de Cinzas', type: 'ponto_facultativo', description: 'Recesso Escolar de Cinzas' },
  ...
  { id: 'hol_2026_06_04', date: '2026-06-04', name: 'Corpus Christi', type: 'ponto_facultativo', description: 'Feriado Municipal / Ponto Facultativo' },
  { id: 'hol_2026_06_05', date: '2026-06-05', name: 'Recesso Escolar (Ponte Corpus Christi)', type: 'recesso', description: 'Recesso Escolar' },
  { id: 'hol_2026_07_13', date: '2026-07-13', name: 'Recesso Escolar de Julho (Semana 1)', type: 'recesso', description: 'Férias / Recesso Escolar de Meio de Ano' },
  { id: 'hol_2026_07_14', date: '2026-07-14', name: 'Recesso Escolar de Julho', type: 'recesso', description: 'Férias / Recesso Escolar de Meio de Ano' },
  { id: 'hol_2026_07_15', date: '2026-07-15', name: 'Recesso Escolar de Julho', type: 'recesso', description: 'Férias / Recesso Escolar de Meio de Ano' },
  { id: 'hol_2026_07_16', date: '2026-07-16', name: 'Recesso Escolar de Julho', type: 'recesso', description: 'Férias / Recesso Escolar de Meio de Ano' },
  { id: 'hol_2026_07_17', date: '2026-07-17', name: 'Recesso Escolar de Julho', type: 'recesso', description: 'Férias / Recesso Escolar de Meio de Ano' },
  ...
  { id: 'hol_2026_12_24', date: '2026-12-24', name: 'Véspera de Natal (Recesso)', type: 'recesso', description: 'Recesso Escolar de Fim de Ano' },
  { id: 'hol_2026_12_25', date: '2026-12-25', name: 'Natal', type: 'feriado', description: 'Feriado Nacional' },
  { id: 'hol_2026_12_31', date: '2026-12-31', name: 'Véspera de Ano Novo (Recesso)', type: 'recesso', description: 'Recesso Escolar de Fim de Ano' },
];
