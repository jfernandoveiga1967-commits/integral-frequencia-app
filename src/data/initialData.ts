...
export const INITIAL_HOLIDAYS: HolidayItem[] = [
  ...
  { id: 'hol_2026_06_04', date: '2026-06-04', endDate: '2026-06-05', name: 'Corpus Christi e Recesso Escolar', type: 'ponto_facultativo', description: 'Feriado Municipal e Ponte de Recesso Escolar' },
  { id: 'hol_2026_07_13', date: '2026-07-13', endDate: '2026-07-24', name: 'Férias Escolares de Julho', type: 'ferias', description: 'Período Oficial de Férias Escolares e Recesso de Meio de Ano' },
