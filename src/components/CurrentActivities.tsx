                      ...
                      {rollCallInfo && (
                        <div className="pt-2">
                          {rollCallInfo.requiresRollCall ? (
                            ...
                            <div className="bg-slate-100/70 rounded-xl p-2.5 border border-slate-200 text-slate-500 text-[11px] font-semibold flex items-center space-x-2">
                  ...
                  <div className="pt-2 border-t border-slate-200/80">
                    ...
                    {nextBlock ? (
                      <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-100/90 border border-slate-200 text-xs">
                        ...
                        <span className="font-bold text-indigo-700 text-[11px] shrink-0 bg-indigo-50 px-2 py-0.5 rounded-lg border border-indigo-100">
